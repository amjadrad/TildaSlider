...
public class TildaSlider extends FrameLayout implements ViewPager.OnPageChangeListener,
    ...
    public TildaSlider(@NonNull Context context) {
        super(context);
    }

    public TildaSlider(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        parseCustomAttributes(attrs);
    }

    public TildaSlider(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
